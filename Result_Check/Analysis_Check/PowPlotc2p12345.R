...
env_c2p1 <- new.env()
load("~/R-Project/mtDNA_mt2/Result_Check/c2p1/modelSmr.Rdata", envir = env_c2p1)
...
### create a new enviroment for one condition
env_c2p2 <- new.env()
load("~/R-Project/mtDNA_mt2/Result_Check/c2p2/modelSmr.Rdata", envir = env_c2p2)
...
### create a new enviroment for one condition
env_c2p3 <- new.env()
load("~/R-Project/mtDNA_mt2/Result_Check/c2p3/modelSmr.Rdata", envir = env_c2p3)
...
### create a new enviroment for one condition
env_c2p4 <- new.env()
load("~/R-Project/mtDNA_mt2/Result_Check/c2p4/modelSmr.Rdata", envir = env_c2p4)
...
### create a new enviroment for one condition
env_c2p5 <- new.env()
load("~/R-Project/mtDNA_mt2/Result_Check/c2p5/modelSmr.Rdata", envir = env_c2p5)
...
ggsave( "~/R-Project/mtDNA_mt2/Result_Check/Analysis_Check/graph_c2p268910.png",g1, width = 6, height = 4.5,  type = "cairo-png", dpi = 900)
