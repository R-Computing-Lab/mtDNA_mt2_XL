...
env_c2p2 <- new.env()
load("~/R-Project/mtDNA_mt2/Result2/c2p2/modelSmr.Rdata", envir = env_c2p2)
...
### create a new enviroment for one condition
env_c2p6 <- new.env()
load("~/R-Project/mtDNA_mt2/Result2/c2p6/modelSmr.Rdata", envir = env_c2p6)
...
### create a new enviroment for one condition
env_c2p8 <- new.env()
load("~/R-Project/mtDNA_mt2/Result2/c2p8/modelSmr.Rdata", envir = env_c2p8)
...
### create a new enviroment for one condition
env_c2p9 <- new.env()
load("~/R-Project/mtDNA_mt2/Result2/c2p9/modelSmr.Rdata", envir = env_c2p9)
...
### create a new enviroment for one condition
env_c2p10 <- new.env()
load("~/R-Project/mtDNA_mt2/Result2/c2p10/modelSmr.Rdata", envir = env_c2p10)
...
ggsave( "~/R-Project/mtDNA_mt2/Result2/Analysis2/graph_c2p268910.png",g1, width = 6, height = 4.5,  type = "cairo-png", dpi = 900)
