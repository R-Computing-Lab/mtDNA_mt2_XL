...
env_c3p2 <- new.env()
load("~/R-Project/mtDNA_mt2/Result_rdped_v3/c3p2/modelSmr.Rdata", envir = env_c3p2)
...
### create a new enviroment for one condition
env_c3p6 <- new.env()
load("~/R-Project/mtDNA_mt2/Result_rdped_v3/c3p6/modelSmr.Rdata", envir = env_c3p6)
...
### create a new enviroment for one condition
env_c3p8 <- new.env()
load("~/R-Project/mtDNA_mt2/Result_rdped_v3/c3p8/modelSmr.Rdata", envir = env_c3p8)
...
### create a new enviroment for one condition
env_c3p9 <- new.env()
load("~/R-Project/mtDNA_mt2/Result_rdped_v3/c3p9/modelSmr.Rdata", envir = env_c3p9)
...
### create a new enviroment for one condition
env_c3p10 <- new.env()
load("~/R-Project/mtDNA_mt2/Result_rdped_v3/c3p10/modelSmr.Rdata", envir = env_c3p10)
...
ggsave( "~/R-Project/mtDNA_mt2/Result_rdped_v3/Analysis_rdped_v3/graph_c3p268910.png",g1, width = 6, height = 4.5,  type = "cairo-png", dpi = 900)
