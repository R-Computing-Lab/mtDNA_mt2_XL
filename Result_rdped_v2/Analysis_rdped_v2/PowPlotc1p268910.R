...
### create a new enviroment for one condition
env_c1p6 <- new.env()
load("~/R-Project/mtDNA_mt2/Result_rdped_v2/c1p6/modelSmr.Rdata", envir = env_c1p6)
...
### create a new enviroment for one condition
env_c1p8 <- new.env()
load("~/R-Project/mtDNA_mt2/Result_rdped_v2/c1p8/modelSmr.Rdata", envir = env_c1p8)
...
### create a new enviroment for one condition
env_c1p9 <- new.env()
load("~/R-Project/mtDNA_mt2/Result_rdped_v2/c1p9/modelSmr.Rdata", envir = env_c1p9)
