...
env_c5p2 <- new.env()
load("~/R-Project/mtDNA_mt2/Result_20k/c5p2/modelSmr.Rdata", envir = env_c5p2)
...
### create a new enviroment for one condition
env_c5p5 <- new.env()
load("~/R-Project/mtDNA_mt2/Result_20k/c5p5/modelSmr.Rdata", envir = env_c5p5)
...
ggsave( "~/R-Project/mtDNA_mt2/Result_20k/Analysis_20k/graph_c5p25.png",g1, width = 6, height = 4.5,  type = "cairo-png", dpi = 900)
