...
env_c4p1 <- new.env()
load("~/R-Project/mtDNA_mt2/Results/c4p1/modelSmr.Rdata", envir = env_c4p1)
...
### create a new enviroment for one condition
env_c4p3 <- new.env()
load("~/R-Project/mtDNA_mt2/Results/c4p3/modelSmr.Rdata", envir = env_c4p3)
...
### create a new enviroment for one condition
env_c4p4 <- new.env()
load("~/R-Project/mtDNA_mt2/Results/c4p4/modelSmr.Rdata", envir = env_c4p4)
...
ggsave( "~/R-Project/mtDNA_mt2/Analysis/graph_c4p1234.png",g1, width = 6, height = 4.5,  type = "cairo-png", dpi = 900)
