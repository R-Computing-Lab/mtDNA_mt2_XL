...
env_c3p1 <- new.env()
load("~/R-Project/mtDNA_mt2/Result_rdped_v3/c3p1/modelSmr.Rdata", envir = env_c3p1)
...
### create a new enviroment for one condition
env_c3p3 <- new.env()
load("~/R-Project/mtDNA_mt2/Result_rdped_v3/c3p3/modelSmr.Rdata", envir = env_c3p3)
...
### create a new enviroment for one condition
env_c3p4 <- new.env()
load("~/R-Project/mtDNA_mt2/Result_rdped_v3/c3p4/modelSmr.Rdata", envir = env_c3p4)
...
ggsave( "~/R-Project/mtDNA_mt2/Result_rdped_v3/Analysis_rdped_v3/graph_c3p1234.png",g1, width = 6, height = 4.5,  type = "cairo-png", dpi = 900)
