...
env_c1p2 <- new.env()
load("~/R-Project/mtDNA_mt2/Result_rdped/c1p2/modelSmr.Rdata", envir = env_c1p2)
...
### create a new enviroment for one condition
env_c1p6 <- new.env()
load("~/R-Project/mtDNA_mt2/Result_rdped/c1p6/modelSmr.Rdata", envir = env_c1p6)
...
### create a new enviroment for one condition
env_c1p8 <- new.env()
load("~/R-Project/mtDNA_mt2/Result_rdped/c1p8/modelSmr.Rdata", envir = env_c1p8)
...
### create a new enviroment for one condition
env_c1p9 <- new.env()
load("~/R-Project/mtDNA_mt2/Result_rdped/c1p9/modelSmr.Rdata", envir = env_c1p9)
...
### create a new enviroment for one condition
env_c1p10 <- new.env()
load("~/R-Project/mtDNA_mt2/Result_rdped/c1p10/modelSmr.Rdata", envir = env_c1p10)
...
ggsave( "~/R-Project/mtDNA_mt2/Result_rdped/Analysis_rdped/graph_c1p268910.png",g1, width = 6, height = 4.5,  type = "cairo-png", dpi = 900)
