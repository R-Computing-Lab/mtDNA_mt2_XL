...
env_c3p1 <- new.env()
load("~/R-Project/mtDNA_mt2/Result_Check/c3p1/modelSmr.Rdata", envir = env_c3p1)
...
### create a new enviroment for one condition
env_c3p2 <- new.env()
load("~/R-Project/mtDNA_mt2/Result_Check/c3p2/modelSmr.Rdata", envir = env_c3p2)
...
### create a new enviroment for one condition
env_c3p3 <- new.env()
load("~/R-Project/mtDNA_mt2/Result_Check/c3p3/modelSmr.Rdata", envir = env_c3p3)
...
### create a new enviroment for one condition
env_c3p4 <- new.env()
load("~/R-Project/mtDNA_mt2/Result_Check/c3p4/modelSmr.Rdata", envir = env_c3p4)
...
### create a new enviroment for one condition
env_c3p5 <- new.env()
load("~/R-Project/mtDNA_mt2/Result_Check/c3p5/modelSmr.Rdata", envir = env_c3p5)
...
ggsave( "~/R-Project/mtDNA_mt2/Result_Check/Analysis_Check/graph_c3p268910.png",g1, width = 6, height = 4.5,  type = "cairo-png", dpi = 900)
