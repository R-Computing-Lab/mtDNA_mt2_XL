...
env_c2p1 <- new.env()
load("~/R-Project/mtDNA_mt2/ResultA2Mt2_20k/c2p1/modelSmr.Rdata", envir = env_c2p1)
...
### create a new enviroment for one condition
env_c2p3 <- new.env()
load("~/R-Project/mtDNA_mt2/ResultA2Mt2_20k/c2p3/modelSmr.Rdata", envir = env_c2p3)
...
### create a new enviroment for one condition
env_c2p4 <- new.env()
load("~/R-Project/mtDNA_mt2/ResultA2Mt2_20k/c2p4/modelSmr.Rdata", envir = env_c2p4)
...
ggsave( "~/R-Project/mtDNA_mt2/ResultA2Mt2_20k/AnalysisA2Mt2_20k/graph_c2p1234.png",g1, width = 6, height = 4.5,  type = "cairo-png", dpi = 900)
