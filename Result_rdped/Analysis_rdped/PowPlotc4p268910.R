...
env_c4p2 <- new.env()
load("~/R-Project/mtDNA_mt2/Result_rdped/c4p2/modelSmr.Rdata", envir = env_c4p2)
...
### create a new enviroment for one condition
env_c4p6 <- new.env()
load("~/R-Project/mtDNA_mt2/Result_rdped/c4p6/modelSmr.Rdata", envir = env_c4p6)
...
### create a new enviroment for one condition
env_c4p8 <- new.env()
load("~/R-Project/mtDNA_mt2/Result_rdped/c4p8/modelSmr.Rdata", envir = env_c4p8)
...
### create a new enviroment for one condition
env_c4p9 <- new.env()
load("~/R-Project/mtDNA_mt2/Result_rdped/c4p9/modelSmr.Rdata", envir = env_c4p9)
...
### create a new enviroment for one condition
env_c4p10 <- new.env()
load("~/R-Project/mtDNA_mt2/Result_rdped/c4p10/modelSmr.Rdata", envir = env_c4p10)
...
ggsave( "~/R-Project/mtDNA_mt2/Result_rdped/Analysis_rdped/graph_c4p268910.png",g1, width = 6, height = 4.5,  type = "cairo-png", dpi = 900)
