...
env_c5p2 <- new.env()
load("~/R-Project/mtDNA_mt2/Result_rdped/c5p2/modelSmr.Rdata", envir = env_c5p2)
...
### create a new enviroment for one condition
env_c5p6 <- new.env()
load("~/R-Project/mtDNA_mt2/Result_rdped/c5p6/modelSmr.Rdata", envir = env_c5p6)
...
### create a new enviroment for one condition
env_c5p8 <- new.env()
load("~/R-Project/mtDNA_mt2/Result_rdped/c5p8/modelSmr.Rdata", envir = env_c5p8)
...
### create a new enviroment for one condition
env_c5p9 <- new.env()
load("~/R-Project/mtDNA_mt2/Result_rdped/c5p9/modelSmr.Rdata", envir = env_c5p9)
...
### create a new enviroment for one condition
env_c5p10 <- new.env()
load("~/R-Project/mtDNA_mt2/Result_rdped/c5p10/modelSmr.Rdata", envir = env_c5p10)
...
ggsave( "~/R-Project/mtDNA_mt2/Result_rdped/Analysis_rdped/graph_c5p268910.png",g1, width = 6, height = 4.5,  type = "cairo-png", dpi = 900)
