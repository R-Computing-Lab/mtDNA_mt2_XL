...
env_c1p1 <- new.env()
load("~/R-Project/mtDNA_mt2/Result_Check/c1p1/modelSmr.Rdata", envir = env_c1p1)
...
### create a new enviroment for one condition
env_c1p2 <- new.env()
load("~/R-Project/mtDNA_mt2/Result_Check/c1p2/modelSmr.Rdata", envir = env_c1p2)
...
### create a new enviroment for one condition
env_c1p3 <- new.env()
load("~/R-Project/mtDNA_mt2/Result_Check/c1p3/modelSmr.Rdata", envir = env_c1p3)
...
### create a new enviroment for one condition
env_c1p4 <- new.env()
load("~/R-Project/mtDNA_mt2/Result_Check/c1p4/modelSmr.Rdata", envir = env_c1p4)
...
### create a new enviroment for one condition
env_c1p5 <- new.env()
load("~/R-Project/mtDNA_mt2/Result_Check/c1p5/modelSmr.Rdata", envir = env_c1p5)
...
ggsave( "~/R-Project/mtDNA_mt2/Result_Check/Analysis_Check/graph_c1p268910.png",g1, width = 6, height = 4.5,  type = "cairo-png", dpi = 900)
